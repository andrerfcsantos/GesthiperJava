...
public final class MenuQueries {
    ...
    public static void menuPrincipal() {
        ...
        while (estadoMenu == MENU_QUERIES) {
            ...
            catalogoClientes = TestesHashMap.getHipermercado().getCatalogoClientes();
            catalogoProdutos = TestesHashMap.getHipermercado().getCatalogoProdutos();
            moduloContabilidade = TestesHashMap.getHipermercado().getContabilidade();
            moduloCompras = TestesHashMap.getHipermercado().getCompras();
