...
public class Contabilidade implements Serializable {
    ...
    HashMap<Produto, FichaProdutoContabilidade> arvoreProdutos;
    ...
    public Contabilidade() {
        ...
        this.arvoreProdutos = new HashMap<>();
    }
    ...
    public HashMap<Produto, FichaProdutoContabilidade> getArvoreProdutos() {
        HashMap<Produto, FichaProdutoContabilidade> tmp = new HashMap<>();
