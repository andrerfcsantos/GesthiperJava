...
public final class MenuQueries {
    ...
    public static void menuPrincipal() {
        ...
        while (estadoMenu == MENU_QUERIES) {
            ...
            catalogoClientes = TestesTreeMap.getHipermercado().getCatalogoClientes();
            catalogoProdutos = TestesTreeMap.getHipermercado().getCatalogoProdutos();
            moduloContabilidade = TestesTreeMap.getHipermercado().getContabilidade();
            moduloCompras = TestesTreeMap.getHipermercado().getCompras();
    ...
    public static MenuActual _01_estatisticasUltimoFicheiro() {
        ...
        String lixo;
        Scanner input = new Scanner(System.in);
        Hipermercado hiper = TestesTreeMap.getHipermercado();
