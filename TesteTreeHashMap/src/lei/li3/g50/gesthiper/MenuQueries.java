...
public final class MenuQueries {
    ...
    public static void menuPrincipal() {
        ...
        while (estadoMenu == MENU_QUERIES) {
            ...
            catalogoClientes = TestesTreeHashMap.getHipermercado().getCatalogoClientes();
            catalogoProdutos = TestesTreeHashMap.getHipermercado().getCatalogoProdutos();
            moduloContabilidade = TestesTreeHashMap.getHipermercado().getContabilidade();
            moduloCompras = TestesTreeHashMap.getHipermercado().getCompras();
    ...
    public static MenuActual _01_estatisticasUltimoFicheiro() {
        ...
        String lixo;
        Scanner input = new Scanner(System.in);
        Hipermercado hiper = TestesTreeHashMap.getHipermercado();
