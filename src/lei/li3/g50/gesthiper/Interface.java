...
public final class Interface {
	...
	public static void leitura() {
		...
		switch (escolha) {
		case 1:
			opcao_le_ficheiro_objecto();
			break;
		case 2:
			opcao_le_ficheiros_genericos();
			break;
		case 3:
			Leitura.le_ficheiro_objecto();
			break;
		case 4:
	...
	public static void opcao_le_ficheiro_objecto() {
		...
		Scanner input = new Scanner(System.in);
		System.out
				.print("Indique o nome do ficheiro objecto que quer ler (incluindo extensao):");
	...
	public static void opcao_le_ficheiros_genericos() {
		...
		Scanner input = new Scanner(System.in);
		System.out
				.print("Indique o nome do ficheiro de produtos que quer ler: ");
		nome_ficheiro_produtos = input.nextLine();
		System.out
				.print("Indique o nome do ficheiro de clientes que quer ler: ");
		nome_ficheiro_clientes = input.nextLine();
		System.out
				.print("Indique o nome do ficheiro de compras que quer ler: ");
		nome_ficheiro_compras = input.nextLine();

		Leitura.le_ficheiros(nome_ficheiro_produtos, nome_ficheiro_clientes,
				nome_ficheiro_compras);
	}
