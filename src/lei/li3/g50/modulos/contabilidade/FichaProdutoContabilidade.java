...
public class FichaProdutoContabilidade implements Serializable {
  ...
  /**
   * Método que recebe um intervalo meses e o tipo de compra, e devolve o total de unidades de
   * produto vendidas nesse intervalo
   * 
   * @see lei.li3.g50.modulos.dados.Mes
   ...
   * @return
   */
  public int getNumUnidadesProdutoVendidasPorIntervaloDeMeses(Mes mes1, Mes mes2,
   ...
   */
  public int getNumComprasProdutoPorIntervaloDeMeses(Mes mes1, Mes mes2, TipoCompra tipo_compra) {
  ...
  /**
   * Método que recebe um intervalo meses e o tipo de compra, e devolve o total faturado nesse
   * intervalo
   * 
   * @see lei.li3.g50.modulos.dados.Mes
   * @see lei.li3.g50.modulos.dados.TipoCompra
   ...
   */
  public double getFacturacaoProdutoPorIntervaloDeMeses(Mes mes1, Mes mes2, TipoCompra tipo_compra) {
   ...
   * 
   */
  public void setNumUnidadesProdutoVendidasPorMesPorTipoCompra(Mes mes, TipoCompra tipo_compra,
      int valor) {
   ...
   * 
   */
  public void addNumUnidadesProdutoVendidasPorMesPorTipoCompra(Mes mes, TipoCompra tipo_compra,
      int valor) {
   ...
   * @return
   */
  public double getNumUnidadesProdutoVendidasPorMesPorTipoCompra(Mes mes, TipoCompra tipo_compra) {
  ...
  public int hashCode() {
    ...
    result =
        prime * result
            + ((facturacaoProdutoPorMes == null) ? 0 : facturacaoProdutoPorMes.hashCode());
    result =
        prime * result
            + ((numComprasProdutoPorMes == null) ? 0 : numComprasProdutoPorMes.hashCode());
    result =
        prime
            * result
            + ((numUnidadesProdutoVendidasPorMes == null) ? 0 : numUnidadesProdutoVendidasPorMes
                .hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!facturacaoProdutoPorMes.equals(other.getMatrizFacturacaoProdutoPorMes())) {
      return false;
    }
    ...
    } else if (!numComprasProdutoPorMes.equals(other.getMatrizNumComprasProdutoPorMes())) {
      return false;
    }
  ...
  public String toString() {
    ...
    sb.append("FichaProdutoContabilidade [numUnidadesProdutoVendidasPorMes="
        + numUnidadesProdutoVendidasPorMes + ", numComprasProdutoPorMes=" + numComprasProdutoPorMes
